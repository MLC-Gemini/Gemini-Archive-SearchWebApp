...
-	Step-1: Open the link - https://geminiarchive-app-tst.gemini.awsnp.national.com.au/
...
-	Step-4: Along with mandatory fields, you can also select from date and to date which are optional fields and click on search to fetch the data.
-	Step-5: The two tables will be displayed cases and documents. By default, documents of the first case id will be displayed in the documents table. To see documents of any other case id , single click on that row of the cases table. To see the case activities of a case id, double click that row of the cases table.
